...
function App() {
    ...
    return (
        <div className="App">
            ...
            <Footer />
            <>
                <PopupWithForm name='new-avatar' title='Обновить аватар' value='Сохранить' onEditAvatar={handleEditAvatarClick}>
                ...
                <PopupWithForm name='edit-profile' title='Редактировать профиль' value='Сохранить' onEditProfile={handleEditProfileClick}>
                ...
                <PopupWithForm name='add-card' title='Новое место' value='Создать' onAddPlace={handleAddPlaceClick}>
