    ...
    return(
        <div className="popup popup_type_show-image">
            ...
            <div className="form form_show-image">
                <button aria-label="Close" type="button" className="form__close-icon form__close-icon_for_img"><img src={buttonClose} className="form__close" alt="Крестик закрытия окна"/></button>
